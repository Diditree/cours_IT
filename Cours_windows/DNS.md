...
- redirection conditionnelle : redirige les requetes DNS vers un redirecteur ciblé, exemple : on redirige toutes les requetes qui vont vers nomdedomaine.intranet vers le redirecteur précisé (1 redirecteur pour un domaine spécifique par exemple)  
